...
public class EstudianteControlador {
    ...
    @PostMapping("/login")
    public EstudianteResponseDTO login(@Valid @RequestBody LoginRequestDTO loginRequestDTO) {
    ...
    @PutMapping("/{id}")
    public EstudianteResponseDTO actualizarEstudiante(@PathVariable Long id,@Valid @RequestBody EstudianteRequestDTO estudianteRequestDTO) {
